...
const FriendRequestSchema = new mongoose_1.default.Schema({
    ...
    sendTo: { type: mongoose_2.Schema.Types.ObjectId, ref: "User", required: true }
}, {
    timestamps: true,
    strictQuery: true
});
...
const FriendRequestModdel = mongoose_1.models.FriendRequest || (0, mongoose_1.model)("FriendRequest", FriendRequestSchema);
exports.default = FriendRequestModdel;
